...
class FORTE_gain_10: public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_gain_10)
...
public:
  FORTE_gain_10(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, nullptr, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_gain_10() = default;
};
