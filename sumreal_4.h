...
#ifndef _SUMREAL_4_H_
#define _SUMREAL_4_H_
...
class FORTE_sumreal_4: public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_sumreal_4)
...
public:
  FORTE_sumreal_4(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, nullptr, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_sumreal_4() = default;
};
