...
class FORTE_tf_3: public CBasicFB{
  DECLARE_FIRMWARE_FB(FORTE_tf_3)
...
private:
  ...
  static const SInternalVarsInformation scm_stInternalVars;
   ...
   FORTE_BASIC_FB_DATA_ARRAY(2, 1, 1, 2, 0);
...
public:
  FORTE_tf_3(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) : 
