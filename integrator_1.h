...
#ifndef _INTEGRATOR_1_H_
#define _INTEGRATOR_1_H_
...
class FORTE_integrator_1: public CBasicFB {
  DECLARE_FIRMWARE_FB(FORTE_integrator_1)
...
public:
  FORTE_integrator_1(CStringDictionary::TStringId pa_nInstanceNameId, CResource *pa_poSrcRes) :
       CBasicFB(pa_poSrcRes, &scm_stFBInterfaceSpec, pa_nInstanceNameId, nullptr, m_anFBConnData, m_anFBVarsData) {
  };

  virtual ~FORTE_integrator_1() = default;
};

#endif // _INTEGRATOR_1_H_
